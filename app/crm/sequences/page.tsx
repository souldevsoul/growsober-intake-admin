    ...
    <div className="min-h-screen bg-black neon-grid-bg text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {showCreate && (
          <Card className="neon-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <label className="text-sm text-white/40 mb-1 block">Description (optional)</label>
                <Input
                  value={newDesc}
        ...
        {loading ? (
          ...
          <p className="text-white/30 text-center py-8">No sequences yet. Create one to get started.</p>
        ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div>
                        ...
                        {seq.description && (
                          <p className="text-sm text-white/40 mt-0.5">{seq.description}</p>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      <span className="text-white/40 mono-num">{seq.steps.length} steps</span>
                      <span className="text-white/40 mono-num">{seq._count.enrollments} enrolled</span>
